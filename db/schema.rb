...
ActiveRecord::Schema.define(version: 20150915065852) do
  ...
  create_table "invoice_items", id: :bigserial, force: :cascade do |t|
    t.integer  "item_id"
  ...
  create_table "merchants", id: :bigserial, force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
